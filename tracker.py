...
from apex_legends_api.al_domain import Event, GameEvent, DataTrackers
import arrow
...
def main():
    ...
    # mongo_uri = f"mongodb://{mongo_user}:{mongo_password}@{mongo_hostname}:{mongo_port}/{mongo_auth_db}"
